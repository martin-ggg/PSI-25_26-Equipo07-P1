...
class AuthorCreateViewTest(TestCase):
    def setUp(self):
        ...
        # Give test_user2 permission to add authors
    ...
    def test_redirects_to_detail_view_on_success(self):
        ...
        # Post data to create a new author
        ...
        # Get the new author to check redirect URL
        # We assume this is the only author created in this test method
        author = Author.objects.last()
        
        # Check that we redirect to the author detail view

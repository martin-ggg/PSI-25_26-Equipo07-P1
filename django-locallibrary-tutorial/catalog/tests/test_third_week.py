...
class ThirdWeekTests(TestCase):
    ...
    def test_tests_models_exist(self):
        ...
        self.assertIn(
            'test_object_name_is_last_name_comma_first_name',
            dir(c1))
    ...
    def test_tests_views_exist(self):
        ...
        self.assertIn(
            'test_forbidden_if_logged_in_but_not_correct_permission',
            dir(c5))
        ...
        self.assertIn(
            ...
            dir(c5))
        self.assertIn(
            'test_redirects_to_all_borrowed_book_list_on_success',
            dir(c5))
    ...
    def test_challenge_one(self):
        ...
        self.assertIn(
            'test_form_date_of_death_initially_set_to_expected_date',
            dir(c6))

...
class Book(models.Model):
    ...
    # clearbut authors can have multiple books.
    ...
    # Nota: display_genre está duplicado en tu código original,
    # pero he mantenido la estructura para no alterar funcionalidad,
    # solo he corregido el largo de línea del docstring.
    def display_genre_duplicate(self):
        """
